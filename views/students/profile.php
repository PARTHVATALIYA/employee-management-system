...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="http://localhost/practice/userManagement/public/assets/css/userProfile.css">
    ...
    ?>
        ...
        <div class="wrapper registrationForm" id="profileForm">
            <div class="inner">
                <h3 class="mt-3">Profile</h3>
                <form class="d-flex justify-content-center registrationForm" id="studentForm">
                    <div class="d-flex align-items-center">
                        <div class="form-wrapper ">        
                            <span class="userProfilePicture" id="userProfilePicture"></span>
                            <div class="profilePicture mt-3">
    ...
    <script src="http://localhost/practice/userManagement/public/assets/js/userProfile.js"></script>
</html>